...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "Hello World", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Hello World";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Hello World", null, { width: 640, height: 480 });
