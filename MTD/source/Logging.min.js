function getLogging() {
    ...
    function Logger() {
        var BASE_URL = "https://gdiac.cis.cornell.edu/cs4154/fall2017/";
        ...
        this.assignABTestValue = function (candidate) {
            if (!_debugMode) {
                if (!localStorage.getItem("ab_test_value")) {
                    _abStoredValue = candidate;
                    localStorage.setItem("ab_test_value", _abStoredValue);
                } else {
                    _abStoredValue = localStorage.getItem("ab_test_value");
                }
                _abValueSet = true;
        ...
        this.recordPageLoad = function (userInfo) {
            ...
            localStorage.setItem('session_id', _sessionId);
        };
